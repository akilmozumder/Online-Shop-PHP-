...
<?php
    if (isset($_GET['shiftid'])){
        ...
        $time=$_GET['time'];
        $price=$_GET['price'];
        $shift=$ct->shiftedOrder($id,$time,$price);
        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                <div class="block">        
					...
					<tbody>
                    <?php
                        $getOrderDetails=$ct->getAllOrderDetails();
                        if ($getOrderDetails){
                            while ($result=$getOrderDetails->fetch_assoc()){
                    ?>
						<tr class="odd gradeX">
                            ...
                            <td><a href="customer.php?cusId=<?php echo $result['cmrId'];?>">View</td>
                            <?php
                                if ($result['status']=='0'){ ?>
